...
CREATE TABLE IF NOT EXISTS `wms`.`Pallet` (
  ...
  PRIMARY KEY (`idPallet`, `Location_Cell_Detail_idLocation_Cell_Detail`, `Location_Cell_Detail_Pallet_idPallet`, `Location_Cell_Detail_Location_Cell_idLocation_Cell`, `Location_Cell_Detail_Location_Cell_Rack_idRack`, `Location_Cell_Detail_Location_Cell_Rack_Warehouse_idWarehouse`, `idDistribution_Center`, `Product_idProduct`, `Product_Trademark_id_Trademark`),
  ...
  INDEX `fk_Pallet_Product1_idx` (`Product_idProduct` ASC, `Product_Trademark_id_Trademark` ASC),
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Type_Condition` (`idType_Condition`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'Condicion 1', 1, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Distribution_Center` (`idDistribution_Center`, `name`, `address`, `pos_x`, `pos_y`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'PUCPDSCENTER', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Warehouse` (`idWarehouse`, `description`, `status`, `created_at`, `updated_at`, `Type_Condition_idType_Condition`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (1, 'PUCPWHS', 1, NULL, NULL, 1, 1, NULL, NULL);
