...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Distribution_Center` (`idDistribution_Center`, `name`, `address`, `pos_x`, `pos_y`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'WAREHOUSE', 'Direccion', 500, 262, 1, NULL, NULL, NULL, NULL);
