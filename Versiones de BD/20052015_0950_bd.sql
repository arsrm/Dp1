...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (72299021, 'Luis Miranda', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', NULL, 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (42103543, 'Ronald Zavala', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', NULL, 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (44872634, 'Gustavo Coronado', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', NULL, 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (46474578, 'Alejandro Rodriguez', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', NULL, 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (49778049, 'Karina Chacon', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', NULL, 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (45946510, 'Luigi Limaylla', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', NULL, 1, NULL, NULL, NULL, 1, 1);
