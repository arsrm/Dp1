...
-- -----------------------------------------------------
-- Table `wms`.`Execution_Algorithm_By_Vehicle`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wms`.`Execution_Algorithm_By_Vehicle` ;

CREATE TABLE IF NOT EXISTS `wms`.`Execution_Algorithm_By_Vehicle` (
  `idExecutionAlgorithmByVehicle` INT NOT NULL AUTO_INCREMENT,
  ...
  `user_created` INT(8) NULL,
  `user_updated` INT(8) NULL,
  PRIMARY KEY (`idExecutionAlgorithmByVehicle`, `Execution_Algorithm_idExecutionAlgorithm`, `Vehicle_idVehicle`, `Vehicle_Vehicle_State_idVehicle_State`, `Vehicle_Driver_idDriver`),
  INDEX `fk_Execution_Vehicle_By_Product_Execution_Algorithm1_idx` (`Execution_Algorithm_idExecutionAlgorithm` ASC),
  INDEX `fk_Execution_Vehicle_By_Product_Vehicle1_idx` (`Vehicle_idVehicle` ASC, `Vehicle_Vehicle_State_idVehicle_State` ASC, `Vehicle_Driver_idDriver` ASC),
  CONSTRAINT `fk_Execution_Vehicle_By_Product_Execution_Algorithm1`
    FOREIGN KEY (`Execution_Algorithm_idExecutionAlgorithm`)
    REFERENCES `wms`.`Execution_Algorithm` (`idExecutionAlgorithm`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Execution_Vehicle_By_Product_Vehicle1`
...
-- -----------------------------------------------------
-- Table `wms`.`Execution_Algorithm_By_Dispatch`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `wms`.`Execution_Algorithm_By_Dispatch` ;

CREATE TABLE IF NOT EXISTS `wms`.`Execution_Algorithm_By_Dispatch` (
  `idExecutionAlgorithmByDispatch` INT NOT NULL AUTO_INCREMENT,
  ...
  `user_created` INT(8) NULL,
  `user_updated` INT(8) NULL,
  PRIMARY KEY (`idExecutionAlgorithmByDispatch`, `Dispatch_Order_idDispatch_Order`, `Execution_Algorithm_idExecutionAlgorithm`),
  INDEX `fk_Execution_Algorithm_By_Dispatch_Dispatch_Order1_idx` (`Dispatch_Order_idDispatch_Order` ASC),
  INDEX `fk_Execution_Algorithm_By_Dispatch_Execution_Algorithm1_idx` (`Execution_Algorithm_idExecutionAlgorithm` ASC),
  CONSTRAINT `fk_Execution_Algorithm_By_Dispatch_Dispatch_Order1`
    FOREIGN KEY (`Dispatch_Order_idDispatch_Order`)
    REFERENCES `wms`.`Dispatch_Order` (`idDispatch_Order`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Execution_Algorithm_By_Dispatch_Execution_Algorithm1`
    FOREIGN KEY (`Execution_Algorithm_idExecutionAlgorithm`)
    REFERENCES `wms`.`Execution_Algorithm` (`idExecutionAlgorithm`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
USE `wms`$$
DROP TRIGGER IF EXISTS `wms`.`Execution_Algorithm_By_Vehicle_BEFORE_INSERT` $$
USE `wms`$$
CREATE DEFINER = CURRENT_USER TRIGGER `wms`.`Execution_Algorithm_By_Vehicle_BEFORE_INSERT` BEFORE INSERT ON `Execution_Algorithm_By_Vehicle` FOR EACH ROW
BEGIN
	SET NEW.created_at = now();
END
$$
...
USE `wms`$$
DROP TRIGGER IF EXISTS `wms`.`Execution_Algorithm_By_Vehicle_BEFORE_UPDATE` $$
USE `wms`$$
CREATE DEFINER = CURRENT_USER TRIGGER `wms`.`Execution_Algorithm_By_Vehicle_BEFORE_UPDATE` BEFORE UPDATE ON `Execution_Algorithm_By_Vehicle` FOR EACH ROW
BEGIN
	SET NEW.created_at = now();
END
$$
...
USE `wms`$$
DROP TRIGGER IF EXISTS `wms`.`Execution_Algorithm_By_Dispatch_BEFORE_INSERT` $$
USE `wms`$$
CREATE DEFINER = CURRENT_USER TRIGGER `wms`.`Execution_Algorithm_By_Dispatch_BEFORE_INSERT` BEFORE INSERT ON `Execution_Algorithm_By_Dispatch` FOR EACH ROW
BEGIN
	SET NEW.created_at = now();
END
$$
...
USE `wms`$$
DROP TRIGGER IF EXISTS `wms`.`Execution_Algorithm_By_Dispatch_BEFORE_UPDATE` $$
USE `wms`$$
CREATE DEFINER = CURRENT_USER TRIGGER `wms`.`Execution_Algorithm_By_Dispatch_BEFORE_UPDATE` BEFORE UPDATE ON `Execution_Algorithm_By_Dispatch` FOR EACH ROW
BEGIN
	SET NEW.updated_at=now();
END
$$
