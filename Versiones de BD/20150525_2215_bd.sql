...
CREATE TABLE IF NOT EXISTS `wms`.`Picking_Order_Detail` (
  ...
  CONSTRAINT `fk_Picking_Order_Detail_Location_Cell_Detail1`
    FOREIGN KEY (`Location_Cell_Detail_idLocation_Cell_Detail`)
    REFERENCES `wms`.`Location_Cell_Detail` (`idLocation_Cell_Detail`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `wms`.`Pallet_By_Product` (
  ...
  `user_created` INT(8) NULL,
  `user_updated` INT(8) NULL,
  PRIMARY KEY (`Pallet_idPallet`, `Product_Trademark_id_Trademark`, `Product_idProduct`),
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Product` (`idProduct`, `name`, `quantity_per_box`, `weight_per_box`, `quantity_boxes_per_pallet`, `physical_stock`, `free_stock`, `status`, `created_at`, `updated_at`, `Type_Condition_idType_Condition`, `cod_ean13`, `Trademark_id_Trademark`, `user_created`, `user_updated`) VALUES (1, 'Sublime', 24, 50, 200, 1000, 200, 1, NULL, NULL, 1, '0081500601005', 1, NULL, NULL);
...
INSERT INTO `wms`.`Profile` (`idProfile`, `name`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 'usuario', 'It is the user profile', 1, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Vehicle_State` (`idVehicle_State`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'Disponible', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Vehicle_State` (`idVehicle_State`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 'No Disponible', 1, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (72299021, 'Luis Miranda', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', 1, 1, NULL, NULL, 1, 1, NULL, NULL);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (42103543, 'Ronald Zavala', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', 1, 1, NULL, NULL, 1, 1, NULL, NULL);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (44872634, 'Gustavo Coronado', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', 1, 1, NULL, NULL, 1, 1, NULL, NULL);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (46474578, 'Alejandro Rodriguez', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', 1, 1, NULL, NULL, 1, 1, NULL, NULL);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (49778049, 'Karina Chacon', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', 1, 1, NULL, NULL, 1, 1, NULL, NULL);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `update_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (45946510, 'Luigi Limaylla', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', 1, 1, NULL, NULL, 1, 1, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Type_Movement` (`idType_Movement`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'Entrada', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Type_Movement` (`idType_Movement`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 'Salida', 1, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Pallet_State` (`idPallet_State`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'Disponible', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Pallet_State` (`idPallet_State`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 'No Disponible', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_loadIntermentOrder', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_searchInternmentOrder', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Movimiento_Interno', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_RequestOrderSearch', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_GenerateDispatchOrders', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_DispatchOrderSearch', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_RegisterReturn', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Carga_Datos', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Cambio_Contraseña', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Reporte_Internamiento', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Guia_Transportista', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Reporte_Despacho', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Reporte_diferencia_Inventario', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Reporte_Kardex_segun_fecha', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Reporte_Stock_fecha', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_Reporte_Libre_disponibilidad', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (2, 'op_generator_simulation', 1, NULL, NULL, NULL, NULL);
