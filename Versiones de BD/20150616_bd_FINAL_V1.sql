...
CREATE TABLE IF NOT EXISTS `wms`.`Vehicle` (
  ...
  `dispatch_number` INT NULL DEFAULT 1,
  `status` INT NULL DEFAULT 1,
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL,
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Type_Condition` (`idType_Condition`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'Refrigerados', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Type_Condition` (`idType_Condition`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 'Temperatura Ambiente', 1, NULL, NULL, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (1, 'Nestle');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (2, 'Ambrosoli');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (3, 'Costa');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (4, 'Arcor');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (5, 'Kraft');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (6, 'Winters');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (7, 'Field');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (8, 'Hershey');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (9, 'Wonka');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (10, 'Twizzlers');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (11, 'Adams');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (12, 'Chipy');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (13, 'Motta');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (14, 'Bimbo');
INSERT INTO `wms`.`Trademark` (`id_Trademark`, `name`) VALUES (15, 'Fenix');
...
-- -----------------------------------------------------
-- Data for table `wms`.`Driver`
-- -----------------------------------------------------
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'Jaime Espindola', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 'Michael Schumaher', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (3, 'Alfonso Lopez', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (4, 'Sebastian Vettel', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (5, 'Fernando Alonso', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (6, 'Felipe Massa', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (7, 'Lewis Hamilton', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (8, 'Jenson Button', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (9, 'Daniel Ricciardo', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Driver` (`idDriver`, `name`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (10, 'Marcus Ericsson', 1, NULL, NULL, NULL, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `wms`.`Vehicle`
-- -----------------------------------------------------
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (1, 'PLACA 1', 'Vehiculo 1', 100000, 1, 1, NULL, NULL, 2, 1, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (2, 'PLACA 2', 'Vehiculo 2', 100000, 1, 1, NULL, NULL, 2, 2, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (3, 'PLACA 3', 'Vehiculo 3', 100000, 1, 1, NULL, NULL, 2, 3, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (4, 'PLACA 4', 'Vehiculo 4', 100000, 1, 1, NULL, NULL, 2, 4, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (5, 'PLACA 5', 'Vehiculo 5', 100000, 1, 1, NULL, NULL, 2, 5, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (6, 'PLACA 6', 'Vehiculo 6', 100000, 1, 1, NULL, NULL, 2, 6, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (7, 'PLACA 7', 'Vehiculo 7', 100000, 1, 1, NULL, NULL, 2, 7, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (8, 'PLACA 8', 'Vehiculo 8', 100000, 1, 1, NULL, NULL, 2, 8, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (9, 'PLACA 9', 'Vehiculo 9', 100000, 1, 1, NULL, NULL, 2, 9, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (10, 'PLACA 10', 'Vehiculo 10', 100000, 1, 1, NULL, NULL, 2, 10, NULL, NULL);
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `password_change`, `status`, `created_at`, `updated_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`, `user_created`, `user_updated`) VALUES (12345678, 'Administrador Sistema', '$2a$12$Z8kyoYj/BVeERiceNdWll.RFi42l/twQSCvJzdA5KzMpNXapKrXy6', 1, 1, NULL, NULL, 1, 1, NULL, NULL);
...
INSERT INTO `wms`.`Type_Movement` (`idType_Movement`, `idSubtype`, `movimiento`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 3, 'Ingreso por ajuste de inventario', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Type_Movement` (`idType_Movement`, `idSubtype`, `movimiento`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 3, 'Salida por ajuste de inventario', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `wms`.`State_Request_Order` (`idStateRequest_Order`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (4, 'Pedido Abastecido', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `wms`.`Windows` (`id_windows`, `description`, `id_menu`) VALUES ('op_Pallet_Product', 'Pallet/Producto', 1);
INSERT INTO `wms`.`Windows` (`id_windows`, `description`, `id_menu`) VALUES ('op_PalletProduct_Location', 'Ubicacion-Pallet/Producto', 1);
INSERT INTO `wms`.`Windows` (`id_windows`, `description`, `id_menu`) VALUES ('op_Location_Cell', 'Celda de Ubicacion', 1);
INSERT INTO `wms`.`Windows` (`id_windows`, `description`, `id_menu`) VALUES ('op_adjustManual', 'Operaciones - Ajuste Manual', 2);
INSERT INTO `wms`.`Windows` (`id_windows`, `description`, `id_menu`) VALUES ('op_adjustAutomatic', 'Operaciones - Ajuste Automatico', 2);
...
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (1, 'op_Pallet_Product', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (1, 'op_PalletProduct_Location', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (1, 'op_Location_Cell', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (1, 'op_adjustManual', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Profile_Windows` (`idProfile`, `id_windows`, `status`, `user_created`, `created_at`, `user_updated`, `updated_at`) VALUES (1, 'op_adjustAutomatic', 1, NULL, NULL, NULL, NULL);
