...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (1, 'PLACA 1', 'Vehiculo 1', 100000, 0, 1, NULL, NULL, 2, 1, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (2, 'PLACA 2', 'Vehiculo 2', 100000, 0, 1, NULL, NULL, 2, 2, NULL, NULL);
INSERT INTO `wms`.`Vehicle` (`idVehicle`, `license_plate`, `name`, `capacity`, `dispatch_number`, `status`, `created_at`, `updated_at`, `Vehicle_State_idVehicle_State`, `Driver_idDriver`, `user_created`, `user_updated`) VALUES (3, 'PLACA 3', 'Vehiculo 3', 100000, 0, 1, NULL, NULL, 2, 3, NULL, NULL);
