...
CREATE TABLE IF NOT EXISTS `wms`.`Picking_Order_Detail` (
  ...
  `user_created` INT(8) NULL,
  `user_updated` INT(8) NULL,
  `Request_Order_Detail_idRequest_Order_Detail` INT(11) NOT NULL,
  `Request_Order_Detail_Request_Order_idRequest_Order` INT(11) NOT NULL,
  PRIMARY KEY (`idPicking_Order_Detail`, `Picking_Order_idPicking_Order`, `Request_Order_Detail_idRequest_Order_Detail`, `Request_Order_Detail_Request_Order_idRequest_Order`),
  ...
  INDEX `fk_Picking_Order_Detail_Request_Order_Detail1_idx` (`Request_Order_Detail_idRequest_Order_Detail` ASC, `Request_Order_Detail_Request_Order_idRequest_Order` ASC),
  ...
  CONSTRAINT `fk_Picking_Order_Detail_Picking_Order1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Picking_Order_Detail_Request_Order_Detail1`
    FOREIGN KEY (`Request_Order_Detail_idRequest_Order_Detail` , `Request_Order_Detail_Request_Order_idRequest_Order`)
    REFERENCES `wms`.`Request_Order_Detail` (`idRequest_Order_Detail` , `Request_Order_idRequest_Order`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
