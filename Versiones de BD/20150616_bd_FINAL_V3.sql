...
-- -----------------------------------------------------
-- Data for table `wms`.`Internment_Order`
-- -----------------------------------------------------
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Internment_Order` (`idInternment_Order`, `date`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (999999999, '2015-06-16', 1, NULL, NULL, NULL, NULL);
