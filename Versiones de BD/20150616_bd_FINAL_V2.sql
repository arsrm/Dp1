...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Distribution_Center` (`idDistribution_Center`, `name`, `address`, `pos_x`, `pos_y`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'WAREHOUSE', 'Direccion', 0, 0, 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `wms`.`Type_Movement` (`idType_Movement`, `idSubtype`, `movimiento`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 4, 'Salida por Rotura', 1, NULL, NULL, NULL, NULL);
INSERT INTO `wms`.`Type_Movement` (`idType_Movement`, `idSubtype`, `movimiento`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (2, 5, 'Salida por Perdida', 1, NULL, NULL, NULL, NULL);
