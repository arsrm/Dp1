...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`Type_Condition` (`idType_Condition`, `description`, `status`, `created_at`, `updated_at`, `user_created`, `user_updated`) VALUES (1, 'Condicion de prueba', NULL, NULL, NULL, NULL, NULL);
