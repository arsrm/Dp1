...
CREATE TABLE IF NOT EXISTS `wms`.`trademark` (
  ...
  `trademark_idtrademark` INT NOT NULL,
  `trademark_idtrademark1` INT NOT NULL,
  PRIMARY KEY (`idtrademark`),
  INDEX `fk_trademark_trademark1_idx` (`trademark_idtrademark` ASC),
  INDEX `fk_trademark_trademark2_idx` (`trademark_idtrademark1` ASC),
  CONSTRAINT `fk_trademark_trademark1`
    FOREIGN KEY (`trademark_idtrademark`)
    REFERENCES `wms`.`trademark` (`idtrademark`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_trademark_trademark2`
    FOREIGN KEY (`trademark_idtrademark1`)
    REFERENCES `wms`.`trademark` (`idtrademark`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `wms`.`Product` (
  ...
  INDEX `fk_Product_trademark_idx` (`trademark_idtrademark1` ASC),
  ...
  CONSTRAINT `fk_Product_trademark1`
    FOREIGN KEY ()
    REFERENCES `wms`.`trademark` ()
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Product_trademark2`
    FOREIGN KEY (`trademark_idtrademark1`)
    REFERENCES `wms`.`Trademark` (`idtrademark`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
START TRANSACTION;
USE `wms`;
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (72299021, 'Luis Miranda', '123456', 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (42103543, 'Ronald Zavala', '123456', 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (44872634, 'Gustavo Coronado', '123456', 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (46474578, 'Alejandro Rodriguez', '123456', 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (49778049, 'Karina Chacon', '123456', 1, NULL, NULL, NULL, 1, 1);
INSERT INTO `wms`.`User` (`idUser`, `name`, `password`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (45946510, 'Luigi Limaylla', '123456', 1, NULL, NULL, NULL, 1, 1);
