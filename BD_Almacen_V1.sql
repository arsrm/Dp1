...
INSERT INTO `wms`.`User` (`idUser`, `Names`, `password`, `status`, `created_at`, `update_at`, `deleted_at`, `Profile_idProfile`, `Distribution_Center_idDistribution_Center`) VALUES (44872634, 'Gustavo Coronado', '123456', 1, NULL, NULL, NULL, 1, 1);
