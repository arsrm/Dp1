 ...
 * @author Kari
 */
public class Frm_SearchWhLibreDisponibilidad extends javax.swing.JFrame {
     ...
     */
    public Frm_SearchWhLibreDisponibilidad() {
        initComponents();
    }

    Frm_SearchWhLibreDisponibilidad(Frm_LibreDisponibilidadReport menu) {
        menuPadre = menu;
        initComponents();
