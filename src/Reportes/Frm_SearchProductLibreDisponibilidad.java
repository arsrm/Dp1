 ...
 * @author Kari
 */
public class Frm_SearchProductLibreDisponibilidad extends javax.swing.JFrame {
    ...
    Frm_LibreDisponibilidadReport menuPadre = new Frm_LibreDisponibilidadReport();

    public Frm_SearchProductLibreDisponibilidad() {
        initComponents();
    }

    Frm_SearchProductLibreDisponibilidad(Frm_LibreDisponibilidadReport menu, Integer idTrade) {
        menuPadre = menu;
        initComponents();
